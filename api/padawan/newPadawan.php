...
if (!is_null($con)){
	...
	$newContact = sprintf("INSERT INTO contact (id, name, lastname, dni, birthdate, country, state, city, address, phone, mobile, email, facebook, twitter, school) VALUES ('%s', '%s', '%s', %s, '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s')",
