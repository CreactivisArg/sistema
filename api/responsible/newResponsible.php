...
if (!is_null($con)){
	...
	if ($resultContact){
		$newResponsible = sprintf("INSERT INTO responsible (id, id_contact, id_status, creation_date) VALUES ((select UUID()), '%s', '%s', now())",$id_contact,$con->real_escape_string($id_status));
		$resultResponsible = $con->query($newResponsible);
