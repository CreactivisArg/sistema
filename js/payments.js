...
CTS.Payments = {
    ...
    setModalPayment : function (title,id) {
        ...
        $('#holderModal').empty().append(
            ...
            +'              <div class="form-group"><label for="month" class="col-sm-2 control-label">Month</label><div class="col-sm-10"><input id="month" type="number" min="1" max="12" step="1" class="form-control"></div></div>'
            +'              <div class="form-group"><label for="year" class="col-sm-2 control-label">Year</label><div class="col-sm-10"><input id="year" type="number" min="2014" step="1" class="form-control"></div></div>'
